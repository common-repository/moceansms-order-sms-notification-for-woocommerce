...
class MoceanWpERP implements Moceansms_PluginInterface, Moceansms_Register_Interface {
    /*
    ...
    */
    ...
    public function get_plugin_settings($with_identifier = false)
    {
        $settings = array(
            ...
            "moceansms_automation_sms_template_new_customer"    => moceansms_get_options("moceansms_automation_sms_template_new_customer", $this->get_option_id()),
            "moceansms_automation_sms_template_new_lead"        => moceansms_get_options("moceansms_automation_sms_template_new_lead", $this->get_option_id()),
            "moceansms_automation_sms_template_new_opportunity" => moceansms_get_options("moceansms_automation_sms_template_new_opportunity", $this->get_option_id()),
            "moceansms_automation_sms_template_new_subscriber"  => moceansms_get_options("moceansms_automation_sms_template_new_subscriber", $this->get_option_id()),
        );
    ...
    private function get_sms_template_fields() {
        return array(
            array(
                'name'    => 'moceansms_automation_sms_template_new_customer',
                'label'   => __( 'New customer SMS message', MOCEANSMS_TEXT_DOMAIN ),
                'desc'    => sprintf('Customize your SMS with <button type="button" id="moceansms-open-keyword-%1$s-[dummy]" data-attr-type="new_leads" data-attr-target="%1$s[moceansms_automation_sms_template_new_customer]" class="button button-secondary">Keywords</button>', $this->get_option_id() ),
                'type'    => 'textarea',
                'rows'    => '8',
                'cols'    => '500',
                'css'     => 'min-width:350px;',
            ...
            array(
                'name'    => 'moceansms_automation_sms_template_new_lead',
                'label'   => __( 'New lead SMS message', MOCEANSMS_TEXT_DOMAIN ),
                'desc'    => sprintf('Customize your SMS with <button type="button" id="moceansms-open-keyword-%1$s-[dummy]" data-attr-type="new_leads" data-attr-target="%1$s[moceansms_automation_sms_template_new_lead]" class="button button-secondary">Keywords</button>', $this->get_option_id() ),
                'type'    => 'textarea',
                'rows'    => '8',
                'cols'    => '500',
                'css'     => 'min-width:350px;',
            ...
            array(
                'name'    => 'moceansms_automation_sms_template_new_opportunity',
                'label'   => __( 'New opportunity SMS message', MOCEANSMS_TEXT_DOMAIN ),
                'desc'    => sprintf('Customize your SMS with <button type="button" id="moceansms-open-keyword-%1$s-[dummy]" data-attr-type="new_leads" data-attr-target="%1$s[moceansms_automation_sms_template_new_opportunity]" class="button button-secondary">Keywords</button>', $this->get_option_id() ),
                'type'    => 'textarea',
                'rows'    => '8',
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], when would be a good time for our sales representative to schedule a call with you to discuss more on our service?', MOCEANSMS_TEXT_DOMAIN )
            ),
            array(
                'name'    => 'moceansms_automation_sms_template_new_subscriber',
                'label'   => __( 'New subscriber SMS message', MOCEANSMS_TEXT_DOMAIN ),
                'desc'    => sprintf('Customize your SMS with <button type="button" id="moceansms-open-keyword-%1$s-[dummy]" data-attr-type="new_leads" data-attr-target="%1$s[moceansms_automation_sms_template_new_subscriber]" class="button button-secondary">Keywords</button>', $this->get_option_id() ),
                'type'    => 'textarea',
                'rows'    => '8',
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], thank you for subscribing to us. We will notify you of HOT contents', MOCEANSMS_TEXT_DOMAIN )
            ),
        );
    }
    ...
    public function send_sms_on($people_id, $args, $people_type)
    {
        ...
        $this->log->add("MoceanSMS", "people_id: {$people_id}");
    ...
    public function send_customer_notification($args, $status)
    {
        ...
        if( $args['country'] != '-1' ) {
            $phone_no = MoceanSMS_SendSMS_Sms::get_formatted_number($args['phone'], $args['country']);
        } else {
            $phone_no = $args['phone'];
        }

...
class MoceanGroundhoggCRM implements Moceansms_PluginInterface, Moceansms_Register_Interface {
    /*
    ...
    */
    ...
    public function get_plugin_settings($with_identifier = false)
    {
        $settings = array(
            ...
            "moceansms_automation_sms_template_unconfirmed"   => moceansms_get_options("moceansms_automation_sms_template_unconfirmed", $this->get_option_id()),
    ...
    private function get_sms_template_fields() {
        return array(
            array(
                ...
                'label'   => __( 'Confirmed status SMS message', MOCEANSMS_TEXT_DOMAIN ),
                'desc'    => sprintf('Customize your SMS with <button type="button" id="moceansms-open-keyword-%1$s-[dummy]" data-attr-type="customer" data-attr-target="%1$s[moceansms_automation_sms_template_confirmed]" class="button button-secondary">Keywords</button>', $this->get_option_id() ),
                'type'    => 'textarea',
                'rows'    => '8',
                'cols'    => '500',
                'css'     => 'min-width:350px;',
            ...
            array(
                'name'    => 'moceansms_automation_sms_template_unconfirmed',
                'label'   => __( 'Unconfirmed status SMS message', MOCEANSMS_TEXT_DOMAIN ),
                'desc'    => sprintf('Customize your SMS with <button type="button" id="moceansms-open-keyword-%1$s-[dummy]" data-attr-type="lead" data-attr-target="%1$s[moceansms_automation_sms_template_unconfirmed]" class="button button-secondary">Keywords</button>', $this->get_option_id() ),
                'type'    => 'textarea',
                'rows'    => '8',
                'cols'    => '500',
                'css'     => 'min-width:350px;',
            ...
            array(
                ...
                'desc'    => sprintf('Customize your SMS with <button type="button" id="moceansms-open-keyword-%1$s-[dummy]" data-attr-type="refused" data-attr-target="%1$s[moceansms_automation_sms_template_unsubscribed]" class="button button-secondary">Keywords</button>', $this->get_option_id() ),
                'type'    => 'textarea',
                'rows'    => '8',
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], we are sorry to see you go, tell us how cna we improve to serve you better in the future ?', MOCEANSMS_TEXT_DOMAIN )
            ),
        );
    }

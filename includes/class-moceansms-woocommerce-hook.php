...
class Moceansms_WooCommerce_Hook implements Moceansms_Register_Interface {
	protected $notification_ins;

	public function __construct( Moceansms_WooCommerce_Notification $notification_ins ) {
		$this->notification_ins = $notification_ins;
	}

	public function register() {
		moceansms_add_actions( $this->get_core_actions() );
	}

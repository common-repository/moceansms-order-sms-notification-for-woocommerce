...
class MoceanSMS_SMSOutbox_View implements Moceansms_Register_Interface {
	...
	public function register() {
        add_filter( 'moceansms_setting_section', array($this, 'set_smsoutbox_setting_section' ) );
		add_filter( 'moceansms_setting_fields',  array($this, 'set_smsoutbox_setting_field' ) );
        add_action( 'moceansms_setting_fields_custom_html', array($this, 'display_smsoutbox_page'), 10, 1);
	}

	public function set_smsoutbox_setting_section( $sections ) {
		$sections[] = array(
            'id'               => 'moceansms_smsoutbox_setting',
            'title'            => __( 'SMS Outbox', MOCEANSMS_TEXT_DOMAIN ),
            'submit_button'    => '',
    ...
    public function display_smsoutbox_page($form_id) {
        if($form_id != 'moceansms_smsoutbox_setting') { return; }
        global $wpdb;
        $db_table_name = MOCEAN_DB_TABLE_NAME;
        ...
        $admin_url = admin_url('options-general.php?page=moceansms-woocoommerce-setting');

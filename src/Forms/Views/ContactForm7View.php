...
if (empty($wpcf7->id())) {
    echo '<h3>';
    esc_html_e('Please save your contact form 7 once.', MOCEANSMS_TEXT_DOMAIN);
    echo '</h3>';
} else {
...
?>
    ...
    <table class="form-table" role="presentation">
        <tbody>
            <tr>
                <th scope="row"><label for="wpcf7moceanapi-settings[visitor_notification]">SMS notification</label></th>
                <td>
                    <fieldset>
                        <label for="wpcf7moceanapi-settings[visitor_notification]">
                            <input type="hidden" name="wpcf7moceanapi-settings[visitor_notification]" value="off">
                            <input
                                type="checkbox"
                                class="checkbox"
                                id="wpcf7moceanapi-settings[visitor_notification]"
                                name="wpcf7moceanapi-settings[visitor_notification]"
                                value="on"
            ...
            <tr>
                <th scope="row"><label for="wpcf7moceanapi-settings[visitor_mobile_field]">Mobile number field</label></th>
                <td>
                    <select class="regular" name="wpcf7moceanapi-settings[visitor_mobile_field]" id="wpcf7moceanapi-settings[visitor_mobile_field]">
            ...
            <tr>
                <th scope="row"><label for="wpcf7moceanapi-settings[visitor_sms_template]">SMS message</label></th>
                <td>
                    <textarea
                        rows="8"
                        cols="500"
                        ...
                        id="wpcf7moceanapi-settings[visitor_sms_template]"
                        name="wpcf7moceanapi-settings[visitor_sms_template]"
                    ><?php echo $visitor_sms_template; ?></textarea>
                    <p class="description">Customize your SMS with <button type="button" id="moceansms-open-keyword[dummy]" data-attr-type="admin" data-attr-target="wpcf7moceanapi-settings[visitor_sms_template]" class="button button-secondary">Keywords</button></p>
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <table class="form-table" role="presentation">
        <tbody>
            <tr>
                <th scope="row"><label for="wpcf7moceanapi-settings[admin_notification]">SMS notification</label></th>
                <td>
                    <fieldset>
                        <label for="wpcf7moceanapi-settings[admin_notification]">
                            <input type="hidden" name="wpcf7moceanapi-settings[admin_notification]" value="off">
                            <input
                                type="checkbox"
                                class="checkbox"
                                id="wpcf7moceanapi-settings[admin_notification]"
                                name="wpcf7moceanapi-settings[admin_notification]"
                                value="on"
            ...
            <tr>
                <th scope="row"><label for="wpcf7moceanapi-settings[admin_mobile_numbers]">Mobile number</label></th>
                <td>
                    <input
                        type="text"
                        class="regular-text"
                        id="wpcf7moceanapi-settings[admin_mobile_numbers]"
                        name="wpcf7moceanapi-settings[admin_mobile_numbers]"
            ...
            <tr>
                <th scope="row"><label for="wpcf7moceanapi-settings[admin_sms_template]">SMS message</label></th>
                <td>
                    <textarea
                        rows="8"
                        cols="500"
                        class="regular-text"
                        style="min-width:350px;;"
                        id="wpcf7moceanapi-settings[admin_sms_template]"
                        name="wpcf7moceanapi-settings[admin_sms_template]"
                    ><?php echo $admin_sms_template ?></textarea>
                    <p class="description">Customize your SMS with <button type="button" id="moceansms-open-keyword[dummy]" data-attr-type="default" data-attr-target="wpcf7moceanapi-settings[admin_sms_template]" class="button button-secondary">Keywords</button></p>,
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <script>
        ...
        jQuery(function($) {
            ...
            $(`#moceansms-open-keyword\\[dummy\\]`).click(function(e) {
